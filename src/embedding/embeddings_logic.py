...
class EmbeddingManager:
    ...
    def store_embeddings_in_qdrant(self, texts: list, embeddings: list, metadata: list = None):
    ...
    def save_embeddings_to_file(self, points: list, file_name: str):
        ...
        dir = "data/embeddings"
        createFolder(dir)  # Create embeddings folder if it doesn't exist
    ...
    def query_qdrant(self, query_text: str, top_k: int = 5):
        ...
        query_embedding = self.vectorStoreManager.embedding_model.embed_query(query_text)
